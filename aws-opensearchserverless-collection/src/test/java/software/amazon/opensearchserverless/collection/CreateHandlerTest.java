...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final CreateCollectionResponse createCollectionResponse = CreateCollectionResponse.builder()
                .createCollectionDetail(CreateCollectionDetail.builder()
                        .id(COLLECTION_ID)
                        .build()
                )
                .build();
    ...
    public void handleRequest_SimpleSuccessStabilization() {
        ...
        final BatchGetCollectionResponse batchGetCollectionResponse3 = BatchGetCollectionResponse.builder()
                .collectionDetails(
                        ImmutableList.of(collectionDetail1, collectionDetail2)
                ).build();
        final BatchGetCollectionResponse batchGetCollectionResponse5 = BatchGetCollectionResponse.builder()
                .collectionDetails(
                        ImmutableList.of(collectionDetail1)
                ).build();
        final BatchGetCollectionResponse batchGetCollectionResponse9 = BatchGetCollectionResponse.builder()
                .collectionDetails(
                        ImmutableList.of(collectionDetail2)
                ).build();
